        ...
        items: [
          BottomNavigationBarItem(
            icon: SvgPicture.asset(
              ...
              colorFilter: ColorFilter.mode(
                index == 0 ? const Color(0xff212121) : const Color(0xff5C5C5C),
                BlendMode.srcIn,
              ),
            ),
            label: 'Home',
          ...
          BottomNavigationBarItem(
            icon: SvgPicture.asset(
              ...
              fit: BoxFit.cover,
              colorFilter: ColorFilter.mode(
                index == 1 ? const Color(0xff212121) : const Color(0xff5C5C5C),
                BlendMode.srcIn,
              ),
            ),
            label: 'Cart',
          ...
          BottomNavigationBarItem(
            icon: SvgPicture.asset(
              ...
              fit: BoxFit.cover,
              colorFilter: ColorFilter.mode(
                index == 2 ? const Color(0xff212121) : const Color(0xff5C5C5C),
                BlendMode.srcIn,
              ),
            ),
            label: ' Favorite',
          ...
          BottomNavigationBarItem(
            icon: SvgPicture.asset(
              ...
              fit: BoxFit.cover,
              colorFilter: ColorFilter.mode(
                index == 3 ? const Color(0xff212121) : const Color(0xff5C5C5C),
                BlendMode.srcIn,
              ),
            ),
            label: 'Profile',
